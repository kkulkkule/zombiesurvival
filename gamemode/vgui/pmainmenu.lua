...
local function SwitchPlayerModel(self)
	...
	chat.AddText(COLOR_LIMEGREEN, "플레이어 모델 변경됨: "..tostring(self.m_ModelName))
...
function MakepPlayerColor()
	...
	local label = EasyLabel(pPlayerColor, "색깔", "ZSHUDFont", color_white)
	...
	local lab = EasyLabel(pPlayerColor, "무기 색깔")
	lab:SetPos(8, y)
	y = y + lab:GetTall()
