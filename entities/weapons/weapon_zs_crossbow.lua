...
if CLIENT then
	SWEP.PrintName = "'임팰러' 크로스포우"
	SWEP.Description = "오래된 무기지만 직선상 다수의 좀비를 한번에 공격할 수 있다."
...
if CLIENT then
	...
	local matScope = surface.GetTextureID("zombiesurvival/scope")
