...
if CLIENT then
	SWEP.PrintName = "메디컬 키트"
	SWEP.Description = "인간을 회복시키는 에너지를 발산하는 장치.\n생존자 그룹의 건강을 책임진다.\n주 공격 버튼으로 다른 인간 치유.\n보조 공격 버튼으로 자가 치유.\n다른 인간을 치유하는 행위는 재사용 대기시간이 짧을 뿐 아니라 포인트까지 준다!"
	SWEP.Slot = 4
	SWEP.SlotPos = 0
...
function SWEP:DrawHUD()
	...
	draw.SimpleText("메디컬 키트", "ZSHUDFontSmall", x, texty, COLOR_GREEN, TEXT_ALIGN_LEFT)
