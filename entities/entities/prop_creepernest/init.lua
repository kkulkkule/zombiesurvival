...
function ENT:OnTakeDamage(dmginfo)
	...
	if attacker:IsValid() and attacker:IsPlayer() and attacker:Team() == TEAM_UNDEAD then
		...
		if owner and owner:IsValid() and owner:Team() == TEAM_UNDEAD and owner ~= attacker and owner:GetZombieClassTable().Name == "Flesh Creeper" and owner:Alive() and owner:GetPos():Distance(self:GetPos()) <= 1024 then
