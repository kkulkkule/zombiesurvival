...
function ENT:DrawTranslucent()
	...
	local epos = self:GetRedLightPos() + Vector(0, 10, 0)
	...
	if ViewDot >= 0 then
		...
		local Size = math.Clamp(Distance * Visibile * ViewDot * 0.9, 20, 300)

		Distance = math.Clamp(Distance, 32, 800)
		local Alpha = math.Clamp((1600 - Distance) * Visibile * ViewDot, 0, 100)
		colLight.a = Alpha
		colWhite.a = Alpha
